...
import { ICurdProps } from './ICurdProps';
...
//single item
interface IListItem {// 'IBookListItem' 
  Title: string,
Age: string;
ID:number;
...
ICurdProps,
  IAllItems
> {
  constructor(props:ICurdProps, state: IAllItems) {
    super(props);
    this.state = {
      AllCurds:[],
      listTitle: undefined,
...
public updateItemInList = (itemID: number) => {
  ...
  public render(): React.ReactElement<ICurdProps> {
    return (
   <><div style={{backgroundColor:"#fcc5b1",padding:"5px", textIndent:"10px"}}> <b> Employee List</b> (Using SPFx Curd Operation)</div><br />
